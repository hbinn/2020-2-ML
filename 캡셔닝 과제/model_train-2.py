...
test_mode = False
learning_rate = 0.001
num_epoches = 10  # 전체 Epoch 횟수
batch_size = 32  # Batch Size 조절
num_display_steps = 5  # 몇 Epoch마다 결과 창을 보여줄지
num_saver_epoches = 3  # 모델을 몇 Epoch마다 저장할지
'''
...
본인 경로로 변경
'''
data_dir = 'C:\\Users\\HB\\Desktop\\homework4\\data'
test_dir = 'C:\\Users\\HB\\Desktop\\homework4\\data\\testing_data'
...
class vedio2text:
    def __init__(self, vocab_num=0, lr=learning_rate, with_attention=True):
...
'''
data_dir = 'C:\\Users\\HB\\Desktop\\homework4\\data'
test_dir = 'C:\\Users\\HB\\Desktop\\homework4\\testing_data'
