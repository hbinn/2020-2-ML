...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes_path', type=str, required=False, default=os.path.join('configs', 'misaeng_classes.txt'),
    ...
    parser.add_argument('--init_epoch', type=int,required=False, default=10,
        help = "Initial training epochs for fine tune training, default=%(default)s // FineTuning 또는 학습 시 초기 Epoch")
    parser.add_argument('--total_epoch', type=int,required=False, default=10,
