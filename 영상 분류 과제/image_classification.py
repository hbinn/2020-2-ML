...
class ModelMgr():
    def __init__(self, target_class=10, data_number = 60000):
    ...
    def get_my_model(self):
        ...
        model = tf.keras.models.Sequential()
        model.add(keras.layers.Dense(64, input_shape=(784,), name='dense_layer', activation='relu'))
        model.add(keras.layers.Dropout(0.4))
        model.add(keras.layers.Dense(32, name='dense_layer_2', activation='relu'))
        model.add(keras.layers.Dropout(0.4))
        model.add(keras.layers.Dense(self.target_class, name='dense_layer_3', activation='softmax'))
